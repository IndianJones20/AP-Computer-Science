...
public class ProcessTransactions
{
	...
	{
		OhBabyATripleAccountClass acct1, acct2; // two test accounts
		...
		// Create two accounts
		acct1 = new OhBabyATripleAccountClass(1000, "Sue", 123);
		acct2 = new OhBabyATripleAccountClass(1000, "Joe", 456);
		...
		System.out.println("Number of Deposits Today: " + OhBabyATripleAccountClass.getDepositCounter());
		System.out.println("Total Amount Deposited: " + OhBabyATripleAccountClass.getTotalDeposited());
		System.out.println("Number of Withdrawals Today: " + OhBabyATripleAccountClass.getWithdrawCounter());
		System.out.println("Total Amount Withdrew: " + OhBabyATripleAccountClass.getTotalWithdrew());
	}
}